...
lib LibGUI
  ...
  fun combo_phstyle(combo : Combo, fstyle : FStyle)
  ...
  fun edit_phstyle(edit : Edit, fstyle : FStyle)
  ...
  fun label_style_over(label : Label, fstyle : FStyle)
  ...
  fun textview_fstyle(view : TextView, fstyle : FStyle)
